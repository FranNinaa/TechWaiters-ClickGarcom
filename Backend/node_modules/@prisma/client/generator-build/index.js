...
async function buildClient({
  ...
  const scriptsDir = import_path7.default.join(__dirname, `${testMode ? "../" : ""}../scripts`);
  ...
  if (generator.previewFeatures.includes("driverAdapters")) {
    ...
    fileMap["wasm.js"] = await import_promises2.default.readFile(import_path7.default.join(scriptsDir, "wasm-da-feature-deactivated.js"), "utf-8");
    fileMap["wasm.d.ts"] = await import_promises2.default.readFile(import_path7.default.join(scriptsDir, "wasm-da-feature-deactivated.d.ts"), "utf-8");
  }
